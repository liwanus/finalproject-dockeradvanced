...
create database dbkuasai;

use dbkuasai;

CREATE USER 'cilsykuasaiuser'@'localhost' IDENTIFIED BY 'cilsykuasaipassword';

GRANT ALL PRIVILEGES ON *.* TO 'cilsykuasaiuser'@'localhost' WITH GRANT OPTION;

GRANT ALL PRIVILEGES ON `dbkuasai`.* TO 'cilsykuasaiuser'@'localhost';
GRANT ALL PRIVILEGES ON `dbkuasai`.* TO 'cilsykuasaiuser'@'%';
